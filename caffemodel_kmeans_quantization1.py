import sys
import numpy as np
sys.path.append("/home/wyx/caffe/python")
sys.path.append("/home/wyx/caffe/caffe_weight_kmeans_compression_master/KMeansRex_master/python/KMeansRex")
import caffe
import KMeansRex
...
def main():
    ...
    net = caffe.Net("/home/wyx/caffe/models/bvlc_alexnet/deploy.prototxt", caffe.TEST)
    net.copy_from("/home/wyx/caffe/models/bvlc_alexnet/bvlc_alexnet.caffemodel")
    ...
    np.savez("alexnet_caffmodel_kweight.npz", **weights_dict)
    return
