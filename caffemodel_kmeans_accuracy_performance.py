...
def main():
    ...
    kmeans_model = np.load("alexnet_caffmodel_kppweight.npz")
    ...
    net.save("alexnet_kmeanskpp.caffemodel")
    if False:
        bin_command = "/home/wyx/caffe/build/tools/caffe.bin"
        solver = "--solver=/home/wyx/caffe/models/bvlc_alexnet/solver.prototxt"
        model_caffe = "-weights "
        caffe_mode = "test"
